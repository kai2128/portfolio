...
import type { ProjectQueryQuery } from '@/gql/graphql'

function ProjectCard({ name, description, imgUrl, url, tags }: ProjectQueryQuery['projects'][number]) {
  return (
    <div className={style.card}>
      <div className='bg-secondary-background flex flex-col md:w-[360px] w-full'>
        <div className='w-full relative h-[230px]'>
          <div className='absolute bg-background rounded-full flex items-center justify-center shadow bottom-0 left-0 m-2 p-2 z-20'>
