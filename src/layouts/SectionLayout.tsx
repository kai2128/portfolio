...
const SectionLayout: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <section id='section' className='relative h-screen w-screen flex items-center justify-center lg:px-36 xl:px-52 z-10 snap-center'>
      ...
      <div className='absolute xl:left-6 bottom-6 flex gap-5'>
